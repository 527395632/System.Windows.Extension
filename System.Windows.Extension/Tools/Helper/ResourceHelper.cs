...
namespace System.Windows.Extension.Tools
{
    public class ResourceHelper
    {
        ...
        {
            Source = new Uri($"pack://application:,,,/System.Windows.Extension;component/Themes/Skin{skin}.xaml")
        };
        ...
        public static ResourceDictionary GetStandaloneTheme()
        {
            return new()
            {
                Source = new Uri("pack://application:,,,/System.Windows.Extension;component/Themes/Theme.xaml")
            };
        }
    }
}